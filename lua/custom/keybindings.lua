...
vim.api.nvim_set_keymap('v', '<C-d>', 'y:put!<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-e>', ':bnext<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-w>', ':bprevious<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-r>', ':!./run.sh<CR>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('i', '<C-r>', '<esc>:!./run.sh<CR>', {noremap = true, silent = true})
